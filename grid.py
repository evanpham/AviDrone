...
def move(n_target, e_target, tolerance=0.5):
    ...
    target = get_location_metres(vehicle.location.global_relative_frame, n_target, e_target)  # NED velocities relative to copter frame (north forward, east right)
...
# vehicle.mode = VehicleMode("RTL") # RTL brings drone to 15m before moving
vehicle.simple_goto(vehicle.home_location, airspeed=0.25)
